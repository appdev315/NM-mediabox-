...
export const translations = {
  ...
  "privateModeDesc": "Эксклюзивный контент без цензуры.",
  ...
  "privateModeDesc": "Exclusive adult content.",
