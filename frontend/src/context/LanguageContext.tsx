...
export const translations = {
  ...
  "comingSoonMediaBox": "Скоро на MediaBox", "chooseAnother": "Выбрать другой фильм",
  ...
  "retry": "Retry",
  "comingSoonMediaBox": "Soon on MediaBox",
