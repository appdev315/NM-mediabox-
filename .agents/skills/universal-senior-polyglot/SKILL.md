...
2. **ОБЯЗАТЕЛЬНЫЙ ВОРКФЛОУ**:
   - **Шаг 1: Анализ и Компактный План**: Проведи исследование и составь лаконичный план (в чате на 5–7 строк).
...
1. **Компактные планы в чате:** Выводить лаконичный план из 5–7 строк прямо в чате (без создания тяжелых артефактов для обычных задач).
